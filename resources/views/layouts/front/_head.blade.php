...
<!-- Favicon -->
<link rel="shortcut icon" type="image/png" href="{{ asset('theme-front/images/favicon.png') }}">
...
<!--==== Animate CSS ====-->
<link rel="stylesheet" href="{{ asset('theme-front/plugins/animate/animate.min.css') }}">

<!--==== Owl Carousel ====-->
<link rel="stylesheet" href="{{ asset('theme-front/plugins/owl-carousel/owl.carousel.min.css') }}">

<!--==== Magnific Popup ====-->
<link rel="stylesheet" href="{{ asset('theme-front/plugins/magnific-popup/magnific-popup.css') }}">
