        ...
        <div class="container-fluid pl-120 pr-120 position-relative">
            <div class="row d-flex align-items-center">
                ...
                <div class="col-lg-3 col-md-4 col-6">
                    <!-- Logo -->
                    <div class="logo">
                        <a href="#"><img src="{{asset('theme2/assets/images/logo.png')}}" alt="" class="img-fluid"></a>
                    </div>
                    <!-- End of Logo -->
                </div>
                    ...
                    <div class="mobile-menu-cover">
                        <ul class="nav mobile-nav-menu">
                            <li class="search-toggle-open">
                                <img src="{{asset('theme2/assets/images/search-icon.svg')}}" alt="" class="img-fluid svg">
                            </li>
                            <li class="search-toggle-close hide">
                                <img src="{{asset('theme2/assets/images/close.svg')}}" alt="" class="img-fluid">
                            </li>
                            <li class="nav-menu-toggle">
                                <img src="{{asset('theme2/assets/images/menu-toggler.svg')}}" alt="" class="img-fluid svg">
                            </li>
                        </ul>
                    </div>
                    <!-- End of Mobile Menu -->
